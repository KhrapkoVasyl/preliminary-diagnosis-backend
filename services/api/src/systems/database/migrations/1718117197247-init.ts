...
//       `CREATE TABLE "diagnostic-types" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt"
//       TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
//       "name" character varying(128) NOT NULL, "description" character varying(500), CONSTRAINT "PK_a3df30e15e1625698657206240d" PRIMARY KEY ("id"))`,
//     );
//     await queryRunner.query(
//       `CREATE TYPE "public"."diagnostic-models_status_enum" AS ENUM('ENABLED', 'DISABLED')`,
//     );
//     await queryRunner.query(
//       `CREATE TABLE "diagnostic-models" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
//       "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying(128) NOT NULL, "description" character varying(500),
//       "queueName" character varying(128) NOT NULL, "status" "public"."diagnostic-models_status_enum" NOT NULL DEFAULT 'ENABLED', "typeId" uuid NOT NULL,
//       CONSTRAINT "UQ_6c6f7bf24b7108d40ed4bafa45c" UNIQUE ("queueName"), CONSTRAINT "PK_6879263d491948e8a1e4e1d0f12" PRIMARY KEY ("id"))`,
//     );
//     await queryRunner.query(
//       `CREATE TABLE "files" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt"
//       TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "fileName" character varying(256) NOT NULL, "fileExt" character varying(256) NOT NULL, "fileNameWithExt"
//       character varying(512) NOT NULL, "pathInStorage" character varying(512) NOT NULL, "mimetype" character varying(256) NOT NULL,
...
//     );
//     await queryRunner.query(
//       `CREATE TABLE "diagnostic-model-versions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
//       "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "name" character varying(128) NOT NULL, "description" character varying(500), "version"
//       integer NOT NULL, "status" "public"."diagnostic-model-versions_status_enum" NOT NULL DEFAULT 'ENABLED', "fileId" uuid NOT NULL, "modelId" uuid NOT NULL,
//       CONSTRAINT "REL_edd4c48b50f81c74bf79b5bf2c" UNIQUE ("fileId"), CONSTRAINT "PK_6137426453e92732bd0dc1ad747" PRIMARY KEY ("id"))`,
//     );
//     await queryRunner.query(
//       `CREATE TABLE "refresh-tokens" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(),
//       "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "value" character varying(512) NOT NULL, "expiresAt" TIMESTAMP NOT NULL, "userId" uuid,
//       CONSTRAINT "UQ_0d4d8f2ef85e0809effe45d9d44" UNIQUE ("value"), CONSTRAINT "PK_8c3ca3e3f1ad4fb45ec6b793aa0" PRIMARY KEY ("id"))`,
//     );
//     await queryRunner.query(
